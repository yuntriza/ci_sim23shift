            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Ringkasan Pelanggan</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section class="content">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Filter Ringkasan Pelanggan</h3>
            ...
            <div class="card-body">
                <?= form_open('laporan/cetak_laporan_pelanggan_overview'); ?>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="tanggal_dari">Dari Tanggal Order</label>
                        ...
                        <div class="form-group col-md-6">
                            <label for="tanggal_sampai">Sampai Tanggal Order</label>
